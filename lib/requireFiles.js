...
//
    ...
    this.primus = new Primus(this.http);
    this.primus.use('multiplex', this.primusMultiplex);
    this.primus.use('resource', this.primusResource);
    this.primus.use('rooms', this.primusRooms);
    this.primus.use('emitter', this.primusEmitter);
    this.primus.use('cluster', this.primusCluster);
