...
//
    ...
    this.primusServer.use('cluster', this.primusMultiplex);
    this.primusServer.use('cluster', this.primusResource);
    this.primusServer.use('cluster', this.primusRooms);
    this.primusServer.use('cluster', this.primusEmitter);
